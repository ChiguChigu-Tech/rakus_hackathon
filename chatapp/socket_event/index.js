...
let messages = [
  ...
  {id: 11, user: "サトウ", text: "ラクラクホテル良さそうだね！", dateTime: new Date(), isLabeled: [false, false, false, false, true, false]},
  {id: 10, user: "イトウ", text: "あ！そこ良さそう！>ここもいいんじゃないかな？『ラクラクホテル』", dateTime: new Date(), isLabeled: [false, false, false, false, true, false]},
  {id: 9, user: "タナカ", text: "ここもいいんじゃないかな？『ラクラクホテル』", dateTime: new Date(), isLabeled: [false, false, false, false, true, false]},
  {id: 8, user: "イトウ", text: "こんなところもみつけたよ。『ムズムズホテル』『ホテルワズラワシーサイド』", dateTime: new Date(), isLabeled: [false, false, false, false, true, false]},
  {id: 7, user: "サトウ", text: "ありがとう！他にもいくつか候補を出して決めたいね", dateTime: new Date(), isLabeled: [false, false, false, false, true, false]},
  {id: 6, user: "タナカ", text: "ここなんてどうですか？ 『ホテルメンドー』", dateTime: new Date(), isLabeled: [false, false, false, false, true, false]},
  {id: 5, user: "サトウ", text: "そう！>日程は3月13日~3月19日ですよね？", dateTime: new Date(), isLabeled: [false, false, false, false, false, false]},
  {id: 4, user: "イトウ", text: "日程は3月13日~3月19日ですよね？", dateTime: new Date(), isLabeled: [false, false, true, false, false, false]},
  {id: 3, user: "サトウ", text: "日程は決まっているから泊まるホテルを決めたいね、どこにしたい？", dateTime: new Date(), isLabeled: [false, false, false, false, true, false]},
